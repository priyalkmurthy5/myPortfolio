...
var libh3 = function(libh3) {
    ...
    if (ENVIRONMENT_IS_NODE) {
        ...
        read_ = function shell_read(filename, binary) {
            ...
            if (!ret) {
                if (!nodeFS) {
                    nodeFS = __turbopack_require__("[externals]/fs [external] (fs, cjs)");
                }
                if (!nodePath) {
                    nodePath = __turbopack_require__("[externals]/path [external] (path, cjs)");
                }
...
//# sourceMappingURL=node_modules_h3-js_dist_h3-js_es_7d24e1.js.map